...
export function Pill({ label, icon: Icon, selected = false, onPress, style, testID }: PillProps) {
...
// Export as CategoryChip for backward compatibility
export const CategoryChip = Pill;
